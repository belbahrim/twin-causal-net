...
uplift = twin_causal(nb_features=input_size, nb_hlayers=1, nb_neurons=256, lrelu_slope=0, batch_size=256,
                     ...
                     save_model=False, verbose=False, logs=True, random_state=1234)

# Fitting model
uplift.fit(X_train, T_train, Y_train)
